             ...
             <div className="bg-white rounded-[3rem] border border-slate-100 shadow-sm overflow-hidden">
                <div className="px-10 py-6 border-b border-slate-50 bg-slate-50/50 flex flex-col md:flex-row items-center justify-between gap-6">
                   <div className="flex items-center gap-3 overflow-x-auto no-scrollbar">
                      <div className="flex bg-white p-1 rounded-2xl border border-slate-200 shadow-inner shrink-0">
                      ...
                      <button onClick={handleBatchTranslate} disabled={isBatchTranslating} className="p-3 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-100 transition-all shadow-sm shrink-0" title="Translate All Markets">
                ...
                <div className="p-10 space-y-10">
                   <div className="grid grid-cols-2 gap-8">
                      <div className="space-y-3">
                         ...
                         <input type="number" step="0.01" value={getFieldValue('optimized_price', 'price')} onChange={(e) => updateField('optimized_price', parseFloat(e.target.value))} onBlur={() => syncToSupabase(localListing)} className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl font-black text-2xl outline-none focus:bg-white transition-all" />
                      </div>
                      <div className="space-y-3">
                         ...
                         <input type="number" step="0.01" value={getFieldValue('optimized_shipping', 'shipping')} onChange={(e) => updateField('optimized_shipping', parseFloat(e.target.value))} onBlur={() => syncToSupabase(localListing)} className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl font-black text-2xl outline-none focus:bg-white transition-all" />
                      </div>
                   </div>
                           ...
                           <div key={i} className="flex gap-4 group">
                              ...
                              <div className="flex-1 space-y-1">
                                 <textarea 
                                   ...
                                   onBlur={() => syncToSupabase(localListing)}
                                   className={`w-full p-4 bg-slate-50 border rounded-2xl text-sm font-bold leading-relaxed focus:bg-white outline-none transition-all ${f.length > 250 ? 'border-red-400 ring-2 ring-red-50' : 'border-slate-200'}`}
