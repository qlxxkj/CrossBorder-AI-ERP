...
export const optimizeListingWithOpenAI = async (cleanedData: CleanedData): Promise<OptimizedData> => {
  ...
  const prompt = `
    ...
    RULES:
    1. 5 Bullets, EACH < 250 chars, MUST start with [KEYWORD].
    2. NO brand names, NO automotive names, NO superlatives (best, perfect, etc).
    3. Return JSON with optimized_title, optimized_features[], optimized_description, search_keywords.
  `;
